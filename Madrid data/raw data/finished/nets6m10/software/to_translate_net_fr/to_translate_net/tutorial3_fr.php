...
Dans la table ci-dessous, vous voyez les nombres de points que vous pouvez gagner dans les interactions avec CHACUN de vos voisins, et fonction de ce que vous faites et de ce qu'ils font. 
<br><br>
...
et 2 de vos voisins choisissent <span style="background-color: #0099CC">BLEU</span> <br>
et 2 de vos voisins choisissent  <span style="background-color: #FFFF33">JAUNE</span> <br>
vous gagnez 2 &#215; <?php echo trim(file_get_contents('data/reward'))?> + 2 &#215; <?php echo trim(file_get_contents('data/suckers'))?> =  <?php echo trim(file_get_contents('data/example1'))?> 
</li> 
<br>

<li> Si vous choisissez <span style="background-color: #FFFF33">JAUNE</span>  <br>
et 1 de vos voisin choisit <span style="background-color: #0099CC">BLEU</span> <br>
et 3 de vos voisins choisissent  <span style="background-color: #FFFF33">JAUNE</span> <br>
vous gagnez 1 &#215; <?php echo trim(file_get_contents('data/temptation'))?> + 3 &#215; <?php echo trim(file_get_contents('data/punishment'))?> =  <?php echo trim(file_get_contents('data/example2'))?> 
</li> 
<br>
<br>

Chaque point que vous gagnez correspond à <?php echo round(trim(file_get_contents('data/pointvalue')),2)?> euros.
La table avec les points pour chaque choix sera aussi visible dans le coin supérieur droit à cuaque étape de l'expérience. 
