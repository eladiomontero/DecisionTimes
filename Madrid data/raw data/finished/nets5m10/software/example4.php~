...
<tr height="30%">
  ...
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="#FFFF33" >
...
<tr height="30%">
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="#FFFF33" >
        <tr><td align=center></td></tr></table> </td>   
  <td align=center> 
      <table border="10" width="90%" height="90%"  bgcolor="#FFFF33" >
        <tr><td align=center> <p style="font-size:30px;"></p>  </td></tr></table>  </td>
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="#0099CC" >
       <tr><td align=center></td></tr></table> </td>   
