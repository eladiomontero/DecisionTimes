...
Gelieve de onderstaande vragen te beantwoorden om na te gaan of het experiment duidelijk is voor jou.<br>
Hoeveel verdien JIJ in de volgende situaties? Aan de rechterkant heb je de tabel met de punten als herinnering.
<br>
...
<br><br>
  ...
  &nbsp;&nbsp;<input type="radio" value="Correct" name="same_partner"> Ja <br>
  &nbsp;&nbsp;<input type="radio" value="Incorrect" name="same_partner"> Neen
  <br><br>

  Zijn de regels van het spel dezelfde voor elke speler? <br>
  &nbsp;&nbsp;<input type="radio" value="Correct" name="same_rules"> Ja <br>
  &nbsp;&nbsp;<input type="radio" value="Incorrect" name="same_rules"> Neen
