...
<?php
  if($_POST['question4']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Incorrect. La réponse correcte est: ".trim(file_get_contents('data/reward'));  
...
Cliquez <input type="submit" value="here" class="btn" name="submit"> pour continuer si toutes les réponses sont correctes ou si vous comprenez vos erreurs. Sinon, levez votre main pour poser des questions.
</form>
