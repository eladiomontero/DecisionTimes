  ...
  function timer()
  {
    ...
    if (count>5)
      ...
      if (count>0)
        ...
        document.getElementById("timer").innerHTML=count + " secs. <br>  <br> MAAK UW KEUZE NU AUB!!!"; // watch for spelling         
  }      
  function clickme()  
  {  
...
<tr height=10% align=center>
  ...
  <td bgcolor="EEEEEE" valign=top><p style="color:777777">  Resterende tijd:</p><br>
   </td> 
...
<tr height="30%">
  ...
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>Buurman 1</td></tr></table> </td>         
  <td align=center> </td>
  <td align=center bgcolor="EEEEEE"> 
   <table hight="50%" bgcolor="EEEEEE">
     ...
     <tr bgcolor="EEEEEE" align=center><br />&nbsp;<br />&nbsp; <p style="color:red; font-size:30px;">Kies een kleur:</p> </tr>
   </table>
  </td>
...
<tr height="30%">
  ...
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
        <tr><td align=center>Buurman 3</td></tr></table> </td>             
  <td align=center>
