...
echo "<FONT COLOR=".$red."> Incorrect. La réponse correcte est : ".trim(file_get_contents('data/suckers'));            
?>    
<br>
<br>
...
<?php
 if($_POST['question2']=='Correct')
     ...
     echo "<FONT COLOR=".$red."> Incorrect. La réponse correcte est : ".trim(file_get_contents('data/punishment')); 
?>
<br>
<br>
...
<?php
  if($_POST['question3']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> 
        Incorrect. La réponse correcte est : ".trim(file_get_contents('data/temptation'));  
?>
...
<?php
  if($_POST['question4']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> La réponse correcte est : ".trim(file_get_contents('data/reward'));  
...
<table height="40%" width="60%" align=right valing=top>
  ...
  <col width="60">
  <col width="60">
     <tr height="40"> <td></td> <td></td> <td colspan=2 align=center> <font size="2"> Le choix de l'autre joueur </font> </td>
     ...
     <tr height="40"> <td></td> <td></td> <td colspan=2 align=center> Votre gain earn </td> </tr>
</table>
...
Cliquez <input type="submit" value="ici" class="btn" name="submit"> pour continuer lorsque toutes les réponses sont correctes ou si vous comprenez vos erreurs. Sinon levez la main pour poser des questions.
</form>
