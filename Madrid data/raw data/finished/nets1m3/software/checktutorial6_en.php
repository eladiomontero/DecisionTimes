...
echo "<FONT COLOR=".$green."> Correct. 4 x 6 = 24 </FONT> <br>";      
else        
echo "<FONT COLOR=".$red."> Incorrect. The correct answer is: 4 x 6 = 24";            
?>    
<br>
<br>
...
<?php
 if($_POST['question2']=='Correct')
     echo "<FONT COLOR=".$green."> Correct. 4 x 0 = 0 </FONT> <br>";
 else
     echo "<FONT COLOR=".$red."> Incorrect. The correct answer is: 4 x 0 = 0"; 
?>
<br>
<br>
...
<?php
  if($_POST['question3']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> 
        Incorrect. The correct answer is: 2 x 1 + 2 x 6 = 14";  
?>
...
<?php
  if($_POST['question4']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Incorrect. The correct answer is: 2 x 0 + 2 x 5 = 10";  
