...
echo "<FONT COLOR=".$green."> Juist </FONT> <br>";      
else        
echo "<FONT COLOR=".$red."> Fout. Het correcte antwoord is : ".trim(file_get_contents('data/suckers'));            
?>    
<br>
<br>
...
<?php
 if($_POST['question2']=='Correct')
     ...
     echo "<FONT COLOR=".$red."> Fout. Het correcte antwoord is : ".trim(file_get_contents('data/punishment')); 
?>
<br>
<br>
...
<?php
  if($_POST['question3']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> 
        Fout. Het correcte antwoord is : ".trim(file_get_contents('data/temptation'));  
?>
...
<?php
  if($_POST['question4']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Fout. Het correcte antwoord is : ".trim(file_get_contents('data/reward'));  
...
Klik <input type="submit" value="here" class="btn" name="submit"> om verder te gaan als al je antwoorden juist waren.  Mochten er foute antwoorden zijn en het is niet duidelijk waarom, steek je hand dan op zodat de onderzoeker je uitleg kan geven.  Het is belangrijk dat je begrijpt hoe dit experiment werkt.
</form>
