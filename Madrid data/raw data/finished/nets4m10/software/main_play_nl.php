  ...
  function timer()
  {
    ...
    if (count>5)
      ...
      if (count>0)
        ...
        document.getElementById("timer").innerHTML=count + " secs. <br> MAAK UW KEUZE NU AUB!!!"; // watch for spelling         
  }      
  function clickme()  
  {  
...
<tr height="30%">
  ...
  <td align=center>
         <?php include_once("Neighbour1.php")?>
  </td>
  <td align=center> </td>
...
<tr height="30%">
  <td align=center>
       <?php include_once("Neighbour4.php")?>
  </td>
         
         
  <td align=center> 
    <?php include_once("You.php")?>
  </td>    
  
  <td align=center>
      <?php include_once("Neighbour2.php")?>
  </td>
...
<tr height="30%">
  <td align=center>
  <td align=center>
     <?php include_once("Neighbour3.php")?>
  </td>
