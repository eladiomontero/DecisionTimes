...
echo "<FONT COLOR=".$green."> Juis </FONT> <br>";      
else        
echo "<FONT COLOR=".$red."> Fout. Het juiste antwoord is: ".trim(file_get_contents('data/suckers'));            
?>    
<br>
<br>
...
<?php
 if($_POST['question2']=='Correct')
     ...
     echo "<FONT COLOR=".$red."> Fout. Het juiste antwoord is: ".trim(file_get_contents('data/punishment')); 
?>
<br>
<br>
...
<?php
  if($_POST['question3']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> 
        Fout.  Het juiste antwoord is: ".trim(file_get_contents('data/temptation'));  
?>
...
<?php
  if($_POST['question4']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Fout.  Het juiste antwoord is: ".trim(file_get_contents('data/reward'));  
...
<?php
  if($_POST['same_partner']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Fout. Je buren in het spel veranderen elke ronde. </FONT>";  
...
<?php
  if($_POST['same_rules']=='Correct')
        ...
        echo "<FONT COLOR=".$red."> Fout. De regels van het spel zijn niet hetzelfde voor iedereen. </FONT>";  
