...
echo "<FONT COLOR=".$green."> Juis. 4 x 5 = 20  </FONT> <br>";      
else        
echo "<FONT COLOR=".$red."> Fout. Het juiste antwoord is: 4 x 5 = 20";            
?>    
<br>
<br>
...
<?php
 if($_POST['question2']=='Correct')
     echo "<FONT COLOR=".$green."> Juist. 4 x 1 = 4 </FONT> <br>";
 else
     echo "<FONT COLOR=".$red."> Fout. Het juiste antwoord is: 4 x 1 = 4"; 
?>
<br>
<br>
...
Druk <input type="submit" value="here" class="btn" name="submit"> om verder te gaan als alle antwoorden juist zijn of als je de fouten in je antwoorden begrijpt. Indien er dingen niet duidelijk zijn, steek je hand op en er zal iemand langskomen om je vraag te beantwoorden.
</form>
