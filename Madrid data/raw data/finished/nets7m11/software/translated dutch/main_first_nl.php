  ...
  function timer()
  {
    ...
    if (count>5)
      ...
      if (count>0)
        ...
        document.getElementById("timer").innerHTML=count + " sec. <br> MAAK UW KEUZE NU AUB!!!"; // watch for spelling         
  }      
</script>
...
<tr height="45%" align=center>
  <td align=center valign=center> 
      <table border="10" width="60%" height="80%"  bgcolor="FFFFFF" >
        <tr><td align=center> <p style="font-size:30px;">Jij</p>  </td></tr>
      </table>  
  </td>
  
  <td bgcolor="EEEEEE" colspan=2>
   <table hight="80%">
     <tr valign=top><p style="color:777777"> Resterende tijd:</p><br>
     </tr> 
     <tr>
...
<tr height="45%" align=center>
  ...
  <td align=center>
      <table border="1" width="30%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>De andere deelnemer</td></tr>
      </table> 
  </td>
 
  <td bgcolor="EEEEEE" colspan=2>
   <table align=center valign=center height=80% width=60%>
     <tr rowspan=2 bgcolor="EEEEEE" align=center> <p style="color:red;font-size:30px">Kies een kleur:</p> 
     </tr>
