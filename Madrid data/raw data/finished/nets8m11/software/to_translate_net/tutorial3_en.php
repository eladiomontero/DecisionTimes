...
you earn 2 &#215; <?php echo trim(file_get_contents('data/reward'))?> + 2 &#215; <?php echo trim(file_get_contents('data/suckers'))?> =  <?php echo trim(file_get_contents('data/example1'))?> 
</li> 
<br>

<li> If you choose <span style="background-color: #FFFF33">YELLOW</span>  <br>
and 1 of your neighbours choose <span style="background-color: #0099CC">BLUE</span> <br>
and 3 of your neighbours choose  <span style="background-color: #FFFF33">YELLOW</span> <br>
you earn 1 &#215; <?php echo trim(file_get_contents('data/temptation'))?> + 3 &#215; <?php echo trim(file_get_contents('data/punishment'))?> =  <?php echo trim(file_get_contents('data/example2'))?> 
</li> 
<br>
<br>
