...
<tr height="33.3%">
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>Ganancias de su vecino 1</td></tr></table> </td>
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>Ganancias de su vecino 2</td></tr></table> </td>         
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>Ganancias de su vecino 3</td></tr></table> </td>   
  <td bgcolor="EEEEEE" align=center><br />&nbsp;<br />&nbsp; <p style="color:red; font-size:20px;">Elija un color:</p> </td>
</tr>
<tr height="33.3%">
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
        <tr><td align=center>Ganancias de su vecino 8</td></tr></table> </td>   
  <td align=center> 
      <table border="10" width="90%" height="90%"  bgcolor="FFFFFF" >
        <tr><td align=center> <p style="font-size:30px;">Sus ganancias</p>  </td></tr></table>  </td>
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
       <tr><td align=center>Ganancias de su vecino 4</td></tr></table> </td>   
  <td bgcolor="EEEEEE" align=center> <?php include_once("buttonC.php")?> </td>
</tr>
<tr height="33.3%">
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
        <tr><td align=center>Ganancias de su vecino 7</td></tr></table> </td>   
  <td align=center>
      <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
        <tr><td align=center>Ganancias de su vecino 6</td></tr></table> </td>             
  <td align=center>
    <table border="1" width="40%" height="40%"  bgcolor="FFFFFF" >
      <tr><td align=center>Ganancias de su vecino 5</td></tr></table> </td>   
...
<tr height=10 align=center>
  <td align=center>
   <p style="color:777777;font-size:15px"> PREVIOUS ROUND </p>
  </td>  
  <td bgcolor="EEEEEE" align=right>
    <p style="color:777777;font-size:15px"> CURRENT ROUND </p>
  </td>
  <td bgcolor="EEEEEE"> 
    <table height="30%" width="50%" align=right>
      <col width="40">
...
<tr height="45%" align=center>
  <td align=center valign=center> 
      <table border="10" width="60%" height="80%"  bgcolor="FFFFFF" >
        <tr><td align=center> <p style="font-size:30px;">You</p>  </td></tr>
      </table>  
  </td>
  
  <td bgcolor="EEEEEE" colspan=2>
   <table hight="80%">
     <tr valign=top><p style="color:777777"> Time left:</p><br>
     </tr> 
     <tr>
...
<tr height="45%" align=center>
  ...
  <td align=center>
      <table border="1" width="30%" height="40%"  bgcolor="FFFFFF" >
         <tr><td align=center>The other participant</td></tr>
      </table> 
  </td>
 
  <td bgcolor="EEEEEE" colspan=2>
   <table align=center valign=center height=80% width=60%>
     <tr rowspan=2 bgcolor="EEEEEE" align=center> <p style="color:red;font-size:30px">Choose a color:</p> 
     </tr>
